...
ggsave(file.path(out_dir, "fig-emmeans-plot.png"), emmeans_plot, width = 5, height = 3, dpi = 300)
...
ggsave(file.path(out_dir, "fig-feeding-plot.png"), feeding_plot, width = 6, height = 4, dpi = 300)
