...
![Fotos of the experimental tank setup showing (left) a catfish in the predator compartment in the light conditions separated from the kōura compartment by a barrier, and (right) an eel in the predator compartment under dark light conditions, with a kōura refuge (half terracotta) in the kōura compartment.](images/NCE_foto.png){#fig-nce-foto}
