...
# combined helper: returns "mean ± SE" string for inline use
...
emm_pairs <- emmeans(lm_feed, ~ treatment | day_starve)
pairs(emm_pairs)
...
# Split data by starvation period
...
# Post-hoc Dunn test if Kruskal significant
dunn.test(df_day4$pellets_per_g, df_day4$treatment, method = "bonferroni")
