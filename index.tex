...
use (0.440 \% to 0.8282 \%), driven primarily by a sharp rise in the
after period, while the catfish treatment showed a more sustained
increase across all periods (0.5252 \% to 0.7373 \%) and the eel
treatment the smallest increase (0.3535 \% to 0.5353 \%;
Figure~\ref{fig-refuge-plot}). Under dark conditions, the pattern
shifted, with the catfish treatment showing the greatest increase
(0.3939 \% to 0.770 \%), while the eel treatment showed a modest and
non-sustained increase (0.2727 \% to 0.4141 \% during exposure,
returning to 0.3636 \% after), and the control remained comparatively
low throughout (0.4737 \% to 0.4747 \%).
...
Figure~\ref{fig-feeding-plot}; \textbf{?@tbl-s4-feeding-ano}), there was
no significant difference in feeding rate between catfish, eel, and
